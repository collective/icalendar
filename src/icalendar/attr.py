...
def _get_rdates(self: Component) -> list[Union[tuple[date, None], tuple[datetime, None], tuple[datetime, datetime], tuple[datetime, timedelta]]]:
    ...
    * :obj:`None` if the end is not specified
    * :class:`datetime.datetime` for an absolute end
    * :class:`datetime.timedelta` for an end relative to the start

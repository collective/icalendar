...
class vRecur(CaselessDict):
    ...
    Purpose: This property defines a rule or repeating pattern for recurring events, to-dos,
    ...
    Conformance: This property can be specified in recurring "VEVENT", "VTODO", and "VJOURNAL"
    ...
    Description: The recurrence rule, if specified, is used in computing the recurrence set.

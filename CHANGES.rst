...
- Created an :meth:`~cal.alarm.Alarm.example` method for the :class:`~cal.alarm.Alarm` component. See `Issue 743 <https://github.com/collective/icalendar/issues/743>`_.

...
- Resolved ``Cannot resolve forward reference in type annotations`` warning in documentation. See `Issue 952 <https://github.com/collective/icalendar/issues/952>`_.
